...
# photo_path_base = '/Users/seo-b/Dropbox/Korea Marten/ESP EU 2021/Camera trap/'
    ...
    for (root, subdirs, files) in os.walk(photo_path_aoi):
        ...
        for step_start_idx in range(0, n_files, batch_size_folder):
            ...
            def foo_get_predicted_filename(x, x2):
                return (out_path + "Result/" + modelname + "/ClassifiedPhotos/" + os.path.relpath(root, photo_path_base) + "/" + x)
