...
writeOGR(costarica_aoi, dsn = paste0(workdir, savedir), layer = "FlickrCR_AOI", driver = "ESRI Shapefile", overwrite_layer = T)
...
# load("RData/flickr_final_workspace_download_??? 1to7390_2Jan2017.RData")
